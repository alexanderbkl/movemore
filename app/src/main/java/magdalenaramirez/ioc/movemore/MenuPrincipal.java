...
public class MenuPrincipal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Redirigir a Interfaz admin si es userAdmin
        if(usr.isAdmin()){
            System.out.println("ES ADMINISTRADOR!!!!");
            intent = new Intent(MenuPrincipal.this,MenuPrincipal_admin.class);
        ...
        mbtn_Filtros.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intent = new Intent(MenuPrincipal.this,MenuFiltros.class);
                startActivity(intent);
                finish();
            }
        });
                    ...
                    public void run() {
                        ...
                        adapter.setOnItemClickListener(new RecyclerViewAdapter_Car.OnItemClickListener() {
                            ...
                            public void onItemClick(int position) {
                                ...
                                intent = new Intent(MenuPrincipal.this, Menu_Coche_Detalle.class);
                                startActivity(intent);
                            }
                        });
                    }
                ...
                switch (menuItem.getItemId()) {
                    case R.id.popup_Tu_Perfil:
                        ...
                        //loadFragment(new Tu_Perfil());
                         intent = new Intent(MenuPrincipal.this, Tu_Perfil.class);
                        startActivity(intent);
                        break;
                    case R.id.popup_Tus_Coches:
                        //loadFragment(new Tus_Coches());
                        intent = new Intent(MenuPrincipal.this, Tus_Coches.class);
                        startActivity(intent);
                        break;
                    case R.id.popup_Tus_Alquileres:
                        //loadFragment(new Tus_Alquileres());
                        intent = new Intent(MenuPrincipal.this, Tus_Alquileres.class);
                        startActivity(intent);
                        break;
                    case R.id.popup_Tus_Reviews:
                        //loadFragment(new Tus_Reviews());
                        intent = new Intent(MenuPrincipal.this, Tus_Reviews.class);
                        startActivity(intent);
                        break;
                    case R.id.popup_Reviews_de_tus_Coches:
                        //loadFragment(new Tus_Reviews_Coches());
                        intent = new Intent(MenuPrincipal.this, Tus_Reviews_Coches.class);
                        startActivity(intent);
                        break;
    ...
    private void logoutSes(){
        ...
        intent = new Intent(MenuPrincipal.this,MainActivity.class);
        startActivity(intent);
        finish();
    }
